...
{
    public class SolVentaRepository : WebApplication1.Repository.ISolVentaRepository
    {
        //private SolVentasDBEntities _entities = new SolVentasDBEntities();
    ...
    public interface ISolVentaRepository
    {
